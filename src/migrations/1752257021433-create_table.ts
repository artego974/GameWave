...
export class CreateTable1752257021433 implements MigrationInterface {
    name = 'CreateTable1752257021433'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`campeonato\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`fotoCampeonato\` varchar(255) NULL, \`description\` text NULL, \`numberOfPlayers\` int NOT NULL, \`timeDate\` datetime NOT NULL, \`gameId\` int NULL, \`hostId\` int NULL, \`participantesId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(100) NOT NULL, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`nickName\` varchar(100) NOT NULL, \`fotoPerfil\` varchar(255) NOT NULL DEFAULT '../../pubic/img/fotoPadrao.png', \`banerPerfil\` varchar(255) NOT NULL DEFAULT '../../pubic/img/banerPadrao.png', \`participantesId\` int NULL, UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), UNIQUE INDEX \`IDX_44b6d4cb3fe916de38974ed9c2\` (\`nickName\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
