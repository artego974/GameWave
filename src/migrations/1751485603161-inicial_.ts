...
export class Inicial_1751485603161 implements MigrationInterface {
    name = 'Inicial_1751485603161'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`Campeonato\` (\`id\` int NOT NULL AUTO_INCREMENT, \`_name\` varchar(255) NOT NULL, \`_description\` text NULL, \`_game\` varchar(100) NOT NULL, \`_numberOfPlayers\` int NOT NULL, \`_timeDate\` datetime NOT NULL, \`hostId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`lives\` (\`id\` int NOT NULL, \`_link\` varchar(255) NOT NULL, \`_titulo\` varchar(255) NOT NULL, \`_subtitulo\` varchar(255) NOT NULL, \`userId\` int NULL, \`gameId\` int NULL, UNIQUE INDEX \`IDX_a13ab593b76cb269fc79af1511\` (\`_link\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`Campeonato\` ADD CONSTRAINT \`FK_917fe5cd028dde4ece3bd08d792\` FOREIGN KEY (\`hostId\`) REFERENCES \`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`Campeonato\` DROP FOREIGN KEY \`FK_917fe5cd028dde4ece3bd08d792\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_a13ab593b76cb269fc79af1511\` ON \`lives\``);
