...
export class CreateTables1754943639063 implements MigrationInterface {
    name = 'CreateTables1754943639063'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`campeonato\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`fotoCampeonato\` varchar(255) NULL DEFAULT 'fotoPadrao', \`description\` text NULL, \`numberOfPlayers\` int NOT NULL, \`date\` date NOT NULL, \`time\` time NOT NULL, \`gameId\` int NULL, \`hostId\` int NULL, \`participantesId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`lives\` (\`id\` int NOT NULL AUTO_INCREMENT, \`img\` varchar(255) NULL DEFAULT 'imagemPadrão', \`link\` text NOT NULL, \`titulo\` varchar(255) NOT NULL, \`subtitulo\` varchar(255) NOT NULL, \`userId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
